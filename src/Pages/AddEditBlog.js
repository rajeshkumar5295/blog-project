...
const AddEditBlog =({user,setActive})=>{
        ...
        const handleSubmit = async (e)=>{
          ...
          if(category && title && tags && file && description && trending){
            ...
            return toast.error("All fields are mandator to fill");
          }
                ...
                <div className="col-10 col-md-8 col-lg-6">
                  <form  className="row blog-form"  onSubmit={handleSubmit} >
                    <div className="col-12 py-3">
                        ...
                        <div className="col-12 py-3">
                          <p className="trending"> It is treandign blog ?</p>
                          ...
                          />
                   <label htmlFor="radioOption" className="form-check-label"  > Yes   &nbsp;
                   </label>
                    <input 
                                type="radio" 
                                className="form-check-input"
                                ...
                                onChange={handleTrending}
                          />
                   <label htmlFor="radioOption" className="form-check-label"  > No  
                   </label>
                          </div>
                        </div>
                         ...
                         <div className="col-12 py-3">
                          <select value={category} onChange={onCategoryChange} className="catg-dropdown" > 
                             <option> Please Select Catgeory  </option>
